...
""" % bcb_dev)
  ...
  script.Print("New build of Project Kasumi Backstage~!")
  script.Print("Welcome to the internals of CiRCLE!")
  script.Print(" ")
  device = GetBuildProp("ro.kasumi.device", OPTIONS.info_dict)
  modver = GetBuildProp("ro.kasumi.version", OPTIONS.info_dict)
